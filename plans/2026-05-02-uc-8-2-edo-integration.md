...
Подплан: [2026-05-02-uc-8-2-functional-requirements.md](2026-05-02-uc-8-2-functional-requirements.md).

**Артефакты:**

- [docs/specs/integration/integration-requirements.md](../docs/specs/integration/integration-requirements.md) — расширен на 4 новых `INT-*`:
