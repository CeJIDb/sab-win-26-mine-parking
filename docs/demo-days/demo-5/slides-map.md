...
| оранжевый  | **cejidb**   | концептуальное                      | 2            |
...
flowchart TB
    ...
    subgraph B2["Блок 2 · Концептуальное · 4 мин · cejidb"]
      direction TB
      B2_1["USM + MVP"]:::cejidb
    ...
    B1_5 -->|skifup → cejidb| B2
    B2 -->|cejidb → Denis| B3
    B3 -->|Denis → mrneatly| B4
...
| 2   | 1.5 → 2        | skifup → cejidb          | «Канва задает направление — концепция воплощает»         |
| 3   | 2 → 3          | cejidb → Denis           | «Концепция очерчена — числовые требования»               |
| 4   | 3 → 4          | Denis → mrneatly         | «Требования зафиксированы — как это устроено внутри»     |
