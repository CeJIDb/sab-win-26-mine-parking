...
Они соответствуют текущей последовательности слайдов `1.jpg`-`5.jpg` и тексту выступления из [demo-3-context-diagram-presentation-3-min.md](/home/cejidb/cursor/sab-win-26-mine-parking/docs/demo-days/demo-3-context-diagram-presentation-3-min.md).
