...
Полный список адаптеров с описанием оборудования — в [ADR-003](adr-003-modular-monolith-c-study.md#что-выбрано). Как каждый из трёх видов логики выглядит в псевдокоде — см. [DDD Bounded Contexts: псевдокод — учебная версия](ddd-pseudocode-study.md).
...
Почему для проекта выбран модульный монолит и как эти контексты в нём размещаются — см. [ADR-003: Почему для учебного проекта выбран модульный монолит](adr-003-modular-monolith-c-study.md).
