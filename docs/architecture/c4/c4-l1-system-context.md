...
Ниже — **внешние программные системы** и **что делает с ними платформа**. Для близости к референсу **Телемед** системы сгруппированы на _контролируемый периметр объекта_ и _сторонние сервисы вне периметра проекта_.
