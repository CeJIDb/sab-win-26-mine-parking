...
C4Container
    ...
    System_Ext(payment_terminals, "Платёжные терминалы объекта", "КПП/выезд:<br>приём оплаты")
    ...
    System_Ext(notify_service, "Сервис уведомлений", "SMS и e-mail")
    ...
    Rel(api, payment_terminals, "Инициирует оплату и получает результат", "REST API")
    ...
    Rel(notif_worker, notify_service, "Отправляет SMS и e-mail", "REST API")
