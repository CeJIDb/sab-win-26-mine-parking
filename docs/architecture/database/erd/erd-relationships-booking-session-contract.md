...
| `entry_access_point_id` | `BIGINT` | NULL | логическая ссылка на `facility.access_points(id)` (ADR-003) |
| `exit_access_point_id` | `BIGINT` | NULL | логическая ссылка на `facility.access_points(id)` (ADR-003) |
...
- `session.parking_sessions.entry_access_point_id -> facility.access_points.id`
- `session.parking_sessions.exit_access_point_id -> facility.access_points.id`
