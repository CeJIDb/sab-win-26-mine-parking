...
Текстовое представление диаграммы по результатам чтения тайлов `impact_map_tiles/tile_r*_c*.png`. Каноническое изображение артефакта сохранено в `assets/impact-map.jpg`, исходное имя файла при импорте было `Impact Map.jpg`. Подзаголовки и формулировки приведены в соответствии с карточками на диаграмме.
...
1. [1. Цель (Goal)](#1-цель-goal)
2. [2. Роли / Акторы (Actors)](#2-роли-акторы-actors)
3. [3. Действия / Влияние (Impacts)](#3-действия-влияние-impacts)
4. [4. Результат / Поставка (Deliverables)](#4-результат-поставка-deliverables)
5. [Сводка по приоритетам (с диаграммы)](#сводка-по-приоритетам-с-диаграммы)
