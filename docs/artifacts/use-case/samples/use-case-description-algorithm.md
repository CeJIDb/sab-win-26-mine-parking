...
[К основному контенту](#алгоритм-описания-функциональных-требований-к-системе-в-формате-use-case)

Авторы: Анна Вичугова | Анна Гасраталиева

## Оглавление

1. [Алгоритм описания функциональных требований к системе в формате Use Case](#алгоритм-описания-функциональных-требований-к-системе-в-формате-use-case)
2. [■ Другие статьи на тему User Stories и Use Cases](#другие-статьи-на-тему-user-stories-и-use-cases)
3. [■ Другие статьи на тему Требований](#другие-статьи-на-тему-требований)
...
На практике подавляющая часть сценариев описывается только текстовым описанием. Пример такого описания разбирается в следующих разделах статьи.
