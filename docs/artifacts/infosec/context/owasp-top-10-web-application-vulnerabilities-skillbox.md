...
1. [Что такое OWASP](#что-такое-owasp)
2. [Нарушение контроля доступа](#нарушение-контроля-доступа)
3. [Недостатки криптографии](#недостатки-криптографии)
4. [Инъекции](#инъекции)
5. [Небезопасный дизайн архитектуры приложения](#небезопасный-дизайн-архитектуры-приложения)
6. [Небезопасная конфигурация](#небезопасная-конфигурация)
7. [Использование уязвимых или устаревших компонентов](#использование-уязвимых-или-устаревших-компонентов)
8. [Ошибки идентификации и аутентификации](#ошибки-идентификации-и-аутентификации)
9. [Нарушения целостности программного обеспечения и данных](#нарушения-целостности-программного-обеспечения-и-данных)
10. [Ошибки логирования и мониторинга безопасности](#ошибки-логирования-и-мониторинга-безопасности)
11. [Подделка запросов на стороне сервера](#подделка-запросов-на-стороне-сервера)
