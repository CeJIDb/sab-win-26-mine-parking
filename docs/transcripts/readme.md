...
1. [Исходные файлы из .docx (в репозитории: .txt)](#исходные-файлы-из-docx-в-репозитории-txt)
2. [Состояние](#состояние)
3. [Использование как контекста](#использование-как-контекста)
4. [Техническая подготовка материалов](#техническая-подготовка-материалов)
5. [Нейминг новых файлов](#нейминг-новых-файлов)
